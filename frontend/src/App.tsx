      ...
      {page === "dashboard" && <>
        ...
        {loading ? <div className="loading">Loading intelligence data…</div> : <>
          <section className="stats-grid">
            ...
            <div className="stat-card stat-purple"><span>Average Confidence</span><strong>{averageConfidence.toFixed(1)}%</strong><small>Across indexed actors</small><ShieldCheck size={18} /></div>
          </section>
